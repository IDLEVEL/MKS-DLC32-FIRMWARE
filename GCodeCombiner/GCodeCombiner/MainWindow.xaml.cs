...
namespace GCodeCombiner
{
    ...
    public partial class MainWindow : Window
    {
        ...
        void Initialize()
        {
            ...
            Task.Run(async () =>
            {
               // var files = await Web.GetFileList();
                //_.Dispatcher.Invoke(() => _.CncFiles.ItemsSource = files);
            });
        ...
        {
            Web.UploadFile("XX.gcode", File.ReadAllText("C:\\Develop\\mill_test\\mill_test\\Карман снаружи_V-D0.2MMA80DEG.tap"));
        }
